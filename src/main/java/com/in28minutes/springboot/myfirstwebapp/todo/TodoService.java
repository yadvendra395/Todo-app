...
// Not needed anymore as TodoRepository is handling everything.....
...
public class TodoService {
	...
	public void deleteById(int id) {
		//Shortcut to get the Todo object with id = "id" and remove it......
		//otherwise we would need to iterate throught the list of Todo using loops......
	...
	public void update(Todo x) {
		Predicate<Todo> predicate = todo -> todo.getId() == x.getId();
		Todo todo = todos.stream().filter(predicate).findFirst().get();
		todo.setDescription(x.getDescription());
		todo.setTargetDate(x.getTargetDate());
	}
}
